...
u$seq = pblapply(u$seq,
	             ...
	             cl = num_proc)
u$n = unlist(pblapply(u$seq, length, cl = num_proc)) #n is number of sequences (umis)
u[, qual := NULL]
...
ulen = unique(nchar(unique(unlist(u$seq)))) #get the lengths of the umis
